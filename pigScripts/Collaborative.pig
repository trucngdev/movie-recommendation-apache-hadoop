...
UI = load '/user/hduser/preprocessOut/part-00000' using PigStorage('\t') as (uid:int,itemid:int,rating:double);
...
--store Prediction into '/CollabPredictedRating'
store RecommendedItems into '/user/hduser/RcomSys/CollabOut';
